...
canvas.addEventListener('touchstart', (event) => {
  isDragging = true;
  startDragOffset.x = event.touches[0].clientX - offsetX;
  startDragOffset.y = event.touches[0].clientY - offsetY;
});
...
//     highlightedBlocks = []; // Limpar destaque ao fechar o modal
//     drawMap(); // Redesenhar o mapa para remover o destaque
//   };
// }
...
window.addEventListener('resize', drawMap); // Redesenhar ao redimensionar